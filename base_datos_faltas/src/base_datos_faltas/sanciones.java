...
public class sanciones extends javax.swing.JFrame {
    ...
    guardar_sanciones guardar= new guardar_sanciones();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("codigo_sanciones");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txt_san, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cod_sancion,descripcion1;
        cod_sancion=txt_san.getText();
        descripcion1=txt_des.getText();
         guardar.registrar_sanciones(cod_sancion, descripcion1);
